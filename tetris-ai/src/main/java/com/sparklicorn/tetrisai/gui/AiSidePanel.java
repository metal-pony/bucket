...
import com.sparklicorn.tetrisai.drivers.DefaultTetrisRunner;
...
public class AiSidePanel extends TetrisSidePanel {
    ...
    private JButton createRunButton() {
        ...
        runButton.addActionListener((e) -> {
            ...
            Future<GameStats> futureResults = DefaultTetrisRunner.asyncRunGame(_game, 0L, false);
            try {
                GameStats results = futureResults.get(1L, TimeUnit.MINUTES);
                System.out.println(results.toString());
            } catch (InterruptedException | ExecutionException | TimeoutException e1) {
                System.err.println("ERROR RETRIEVING GAME RUN RESULTS.");
                e1.printStackTrace();
            }
        });
