package com.metal_pony.tetrisai;
	...
	******************/
	...
	public static Set<Position> getPossiblePlacements(TetrisState state) {
		...
		if (startPosition.rowOffset() < topMostBlockRow) {
			...
			// TODO Why is this commented out again? Was it not needed because of the line above?
