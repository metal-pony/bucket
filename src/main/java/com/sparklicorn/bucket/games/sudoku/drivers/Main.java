package com.sparklicorn.bucket.games.sudoku.drivers;
...
public class Main {
  ...
  private static void play(Map<String,String> args) {
    ...
    SudokuGuiDemo.main(new String[] { Integer.toString(clues) });
  }

  private static void generateConfigs(Map<String,String> args) {
    defaultInMap(args, "amount", "1");
  ...
  private static void generatePuzzles(Map<String,String> args) {
    defaultInMap(args, "amount", "1");
    defaultInMap(args, "clues", "27");
  ...
  private static void solve(Map<String,String> args) {
  ...
  private static void generate(Map<String,String> args) {
    defaultInMap(args, "amount", "1");
  ...
  private static void benchmark(Map<String,String> args) {
